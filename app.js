...
// *********************************************************** //
// const courses = require('./public/data/books.json')
const atitles = require('./public/data/Animedata.json')
...
app.post('/courses/byStudio',
  // show list of courses in a given subject
  async (req,res,next) => {
    const {studio} = req.body;
    const courses = await Animedata.find({studio:studio})
    res.locals.courses = courses
    res.render('courselist')
  }
)

app.post('/courses/byhypenumber',
  async (req,res,next) => {
    const {hypenumber} = req.body;
    const courses = await Animedata.find({hype:hypenumber}) 
    res.locals.courses = courses
    res.render('courselist')
  }
)
...
// app.get('/courses/byTitle/:Title',
//   // show all info about a course given its courseid
//   async (req,res,next) => {
//     const Title= req.params;
//     const anime = await Animedata.find({Title:{$regex:Title, $options:'i'}})
//     res.locals.courses = courses
